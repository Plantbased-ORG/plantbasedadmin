...
export default function DashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState<'password' | 'reviews'>('reviews');
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg shadow-lg p-6 mb-8 text-white">
          ...
          <p className="text-purple-100">Manage your admin account, reviews, and settings.</p>
        </div>
        ...
        {/* Tab Content */}
        {activeTab === 'reviews' ? <AddReviewForm /> : <ChangePasswordForm />}
